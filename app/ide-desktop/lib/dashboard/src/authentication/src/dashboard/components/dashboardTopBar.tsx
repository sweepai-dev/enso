/** @file The top bar of the dashboard. */
...
/** Props for a {@link DashboardTopBar}. */
...
/** The {@link DashboardTopBarProps.setQuery} parameter is used to communicate with the parent component,
